      ...
      <div id="splash">
        ...
        <div id="mid">
          <div className="inner legal">
            ...
            <p>You may upload content, including text and images, as a part of the features of the Sites (“Submissions”). You acknowledge that as a part of the functionality of the Sites, some if not all of your Submissions may be re-used by others, and you agree to license all your Submissions under a <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-ShareAlike 3.0 Unported license</a>, or any later version. You represent and warrant that that you have all necessary rights and permissions to license your Submissions under a CC BY-SA license and that the uses contemplated on the Sites will not infringe the proprietary or intellectual property rights of any third party.</p>
